...
class GitHubMCPServer {
  ...
  private ensureOctokit(args: any) {
  ...
  private async configure(args: any) {
    ...
    this.octokit = new Octokit({ auth: args.token });
  ...
  private async getRepoStructure(args: any) {
    const { owner, repo } = this.ensureOctokit(args);
  ...
  private async getLanguages(args: any) {
    const { owner, repo } = this.ensureOctokit(args);
  ...
  private async getContributors(args: any) {
    const { owner, repo } = this.ensureOctokit(args);
